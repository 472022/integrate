    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Search Box -->
                    <input type="text" id="search-input" class="form-control" placeholder="Search..." style="width: 100%; margin-bottom: 20px;">

                    <!-- Performance Tracking Table -->
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0" id="performance-table">
                            <thead>
                                <tr>
                                    <th>Student Name</th>
                                    <th>Email</th>
