...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active " href="view_internships.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>box-3d-50</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Internships</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Internships</h6>
        </nav>
      </div>
    </nav>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <input type="text" id="search_internship_count" class="form-control" placeholder="Search by Internship Count">
            </div>
          </div>
  ...
  <!-- jQuery and AJAX for dynamic search -->
  <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  <script>
    $(document).ready(function(){
      function load_data(query_params) {
        $.ajax({
          url: "fetch_internship.php",
          method: "POST",
          data: query_params,
          success: function(data){
            $('#internship_list').html(data);
          }
        });
      }

      // Load all internships on page load
      load_data();

      // Filter internships based on input fields
      $('#search_name, #search_email, #search_internship_count').on('keyup', function(){
        var name = $('#search_name').val();
        var email = $('#search_email').val();
        var internship_count = $('#search_internship_count').val();
