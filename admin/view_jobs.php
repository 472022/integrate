...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
          <a class="nav-link active " href="view_jobs.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container">
      ...
      <!-- Unified Search Box -->
      <input type="text" id="search_all" class="search-box" placeholder="Search jobs...">

      <!-- Job Listings Grid -->
      <div class="job-grid" id="job_list">
    ...
    <script>
      $(document).ready(function(){
          function load_data(query) {
              $.ajax({
                  url: "fetch_jobs.php", // This file will return job cards based on search query
                  method: "POST",
                  data: {query: query},
          ...
          // Filter jobs based on input from unified search box
