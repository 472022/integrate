...
<head>
  ...
  <title>Manage Coordinators - TPO Dashboard</title>
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="sidenav-header">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active " href="manage_coordinators.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Coordinators</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Coordinators</h6>
        </nav>
      </div>
    </nav>
    <!-- End Navbar -->
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="../assets/img/team-2.jpg" class="avatar avatar-sm me-3" alt="avatar">
                          </div>
                      ...
                      <td class="align-middle text-center">
                        <a href="edit_coordinator.php?id=<?php echo $row['id']; ?>" class="text-sm btn btn-sm btn-primary">Edit</a>
                        <a href="delete_coordinator.php?id=<?php echo $row['id']; ?>" class="text-sm btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this coordinator?')">Delete</a>
                      </td>
                    </tr>
                    <?php endwhile; ?>
                  </tbody>
  ...
  <!-- Modal for adding new coordinator -->
  <div class="modal fade" id="addCoordinatorModal" tabindex="-1" aria-labelledby="addCoordinatorModalLabel" aria-hidden="true">
