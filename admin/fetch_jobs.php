    ...
    <div class="job-grid">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="job-card">
                    <div class="job-image">
                        <img src="../uploads/logos/' . $row['logo'] . '" alt="' . $row['comname'] . '">
                    </div>
                    <div class="job-content">
                        ...
                        <div class="action-buttons">
                            <a href="edit_job.php?job_id=' . $row['id'] . '" class="apply-btn">Edit</a>
                            <a href="delete_job.php?job_id=' . $row['id'] . '" class="apply-btn delete-btn">Delete</a>
                        </div>
                    </div>
                </div>';
            }
