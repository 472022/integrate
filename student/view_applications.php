...
// Modify the query and ensure that the comname column exists in the jobs table
$result = $conn->query("SELECT applications.*, jobs.title AS job_title, jobs.comname 
                        FROM applications
