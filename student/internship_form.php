...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active " href="internship_form.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>box-3d-50</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Internships Form</span>
          </a>
        </li>
        <li class="nav-item">
            ...
            <div class="card-body">
              <form action="add_job.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="date" name="start_date" required></input>
                </div>
                <div class="form-group">
                  <label for="skills">End Date:</label>
                  <input ] class="form-control" type="date" name="end_date"  required>
                </div>
                <div class="form-group">
                  <label for="domain">Stipend:</label>
                ...
                <div class="form-group">
                  <label for="experience">Supervisor Name:</label>
                  <input type="text" class="form-control" name="supervisor_name" required>
                </div>
                <div class="form-group">
                  <label for="salary">Supervisor Contact:</label>
                  <input type="text" class="form-control" name="supervisor_contact"required>
                </div>
                
                <button type="submit" class="btn btn-primary mt-3">Add Internship</button>
              </form>
            </div>
          </div>
        </div>
